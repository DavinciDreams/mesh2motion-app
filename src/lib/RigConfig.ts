...
export class RigConfig {
  static readonly all: RigConfigEntry[] = [
    ...
    {
      skeleton_type: SkeletonType.Alpaca,
      model_file: 'models/model-alpaca.glb',
      rig_file: 'rigs/rig-alpaca.glb',
      rig_display_name: 'Alpaca',
      animation_files: ['../animations/alpaca-animations.glb'],
      animation_preview_folder: 'alpaca',
      has_hand_options: false,
      has_head_weight_correction: false,
      has_arm_extension: false,
      position_tracking_bone_name: 'Body',
    ...
    {
      skeleton_type: SkeletonType.Cow,
      model_file: 'models/model-cow.glb',
      rig_file: 'rigs/rig-cow.glb',
      rig_display_name: 'Cow',
      animation_files: ['../animations/cow-animations.glb'],
      animation_preview_folder: 'cow',
      has_hand_options: false,
      has_head_weight_correction: false,
      has_arm_extension: false,
      position_tracking_bone_name: 'Body',
    ...
    {
      skeleton_type: SkeletonType.FoxQ,
      model_file: 'models/model-foxq.glb',
      rig_file: 'rigs/rig-foxq.glb',
      rig_display_name: 'Fox (Quaternius)',
      animation_files: ['../animations/foxq-animations.glb'],
      animation_preview_folder: 'foxq',
      has_hand_options: false,
      has_head_weight_correction: false,
      has_arm_extension: false,
      position_tracking_bone_name: 'Body',
    ...
    {
      skeleton_type: SkeletonType.GermanShepherd,
      model_file: 'models/model-german-shepherd.glb',
      rig_file: 'rigs/rig-german-shepherd.glb',
      rig_display_name: 'German Shepherd',
      animation_files: ['../animations/german-shepherd-animations.glb'],
      animation_preview_folder: 'german-shepherd',
      has_hand_options: false,
      has_head_weight_correction: false,
      has_arm_extension: false,
      position_tracking_bone_name: 'def-spine004',
    } satisfies RigConfigEntry,
    {
      skeleton_type: SkeletonType.AnimatedHorse,
      model_file: 'models/model-animated-horse.glb',
      rig_file: 'rigs/rig-animated-horse.glb',
      rig_display_name: 'Animated Horse',
      animation_files: ['../animations/animated-horse-animations.glb'],
      animation_preview_folder: 'animated-horse',
      has_hand_options: false,
      has_head_weight_correction: false,
      has_arm_extension: false,
      position_tracking_bone_name: 'hips_03',
    } satisfies RigConfigEntry,
    {
    ...
    {
      skeleton_type: SkeletonType.HorseWhite,
      model_file: 'models/model-horsewhite.glb',
      rig_file: 'rigs/rig-horsewhite.glb',
      rig_display_name: 'Horse (White)',
      animation_files: ['../animations/horsewhite-animations.glb'],
      animation_preview_folder: 'horsewhite',
      has_hand_options: false,
      has_head_weight_correction: false,
      has_arm_extension: false,
      position_tracking_bone_name: 'Body',
    ...
    {
      skeleton_type: SkeletonType.ShibaInu,
      model_file: 'models/model-shibainu.glb',
      rig_file: 'rigs/rig-shibainu.glb',
      rig_display_name: 'Shiba Inu',
      animation_files: ['../animations/shibainu-animations.glb'],
      animation_preview_folder: 'shibainu',
      has_hand_options: false,
      has_head_weight_correction: false,
      has_arm_extension: false,
      position_tracking_bone_name: 'Body',
